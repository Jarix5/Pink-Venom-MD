...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PINKVENOM-MD;id9WGTiK#YNpg_oet-gqt0FwIHWQKZfGR1FN_xgFQHrcO7EHupxk' : process.env.SESSION_ID, //ADD YOUR SESSION ID
